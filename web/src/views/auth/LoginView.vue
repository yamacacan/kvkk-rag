  ...
  <form @submit.prevent="giris" novalidate>
    ...
    <div class="mt-4">
      ...
      <div class="mb-2">
        ...
        <p class="text-[11px] text-[var(--t2)]"><strong class="font-semibold">Not:</strong> Veriler 25 dakika gibi bir sürede sıfırlanır belge üretimleri demo modunda yoktur</p>
      </div>
    </div>
  </form>
</template>
